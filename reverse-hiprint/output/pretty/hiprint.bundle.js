      ...
      BasePrintElement = (function () {
        ...
        return (
          ...
          (BasePrintElement.prototype.getFormatter = function () {
            ...
            if (
              (this.printElementType.formatter && (formatter = this.printElementType.formatter),
          ...
          (BasePrintElement.prototype.getStyler = function () {
            var fnstyler = void 0
            if (
              (this.printElementType.styler && (fnstyler = this.printElementType.styler),
              this.options.styler)
            )
              try {
      ...
      TableExcelHelper = (function () {
        ...
        return (
          ...
          (TableExcelHelper.getRowStyler = function (options, tablePrintElementType) {
            ...
            if (
              (tablePrintElementType.rowStyler && (rowStyler = tablePrintElementType.rowStyler),
              options.rowStyler)
            )
              try {
        ...
        return (
          (t.prototype.css = function (t, e) {
            if (t.find('table').length) {
              if ('border' == e)
                return (t.find('table').css('border', '1px solid'), 'border:1px solid')
              'noBorder' == e
        ...
        return (
          (t.prototype.css = function (t, e) {
            if (t.find('tbody tr').length) {
              if ('border' == e)
                return (t.find('tbody tr').css('border', '1px solid'), 'border:1pt solid')
              'noBorder' == e
      ...
      o = (function () {
        ...
        return (
          ...
          (t.prototype.singleSelectByXY = function (t, e) {
            ...
            n &&
              (this.clear(),
              n && (n.cell.select(), (this.startCell = n), (this.selectedCells = [])))
          }),
      ...
      TablePrintElement = (function (_super) {
        function TablePrintElement(t, e) {
          ...
          return (
            ...
            (n.options = new _option_TablePrintElementOption__WEBPACK_IMPORTED_MODULE_5__.a(
              e,
              n.printElementType,
            )),
        ...
        return (
          ...
          (TablePrintElement.prototype.getPaperHtmlResult = function (t, e) {
            ...
            for (
              var a, p = this.getBeginPrintTopInPaperByReferenceElement(t), s = 0, l = !1;
              !l;
            ) {
              var u = 0,
                  ...
                  $(p).hidraggable({
                    ...
                    onStopDrag: function onStopDrag(t) {
                      var n = parseFloat(e.dragingGrip.target.css('top').replace('px', '')),
                        i = r.a.px.toPt(
                          n - e.dragingGrip.top + e.rows[a].columns[0].getTarget().height(),
                        )
        ...
        (t.prototype.deleteColums = function () {
          ...
          o.forEach(function (e, n) {
            ...
            i.cell
              ...
              : 'row' == i.linkType &&
                ((i.link.colspan -= 1), i.link.getTarget().attr('colspan', i.link.colspan))
          })
        }),
      ...
      function e(e) {
        ...
        ;(o &&
          ...
          e.data.parent != document.body &&
            ((a += t(e.data.parent).scrollLeft()), (p += t(e.data.parent).scrollTop())),
          ...
          ;(n(t).each(function () {
            ...
            ;((i.maxPanelIndex += 1),
              e.options.noContainer
                ? (o = n(t))
                : (o = n(
                    '<div panelIndex=' + i.maxPanelIndex + ' class="resize-panel"></div>',
                  )).css({
                    width: '100%',
                    height: '100%',
                    top: 0,
  ...
  function (t, e, n) {
    ...
    function y(t, e) {
      ...
      if (e.transform && t.css) {
        if (
          !(r = 'function' == typeof e.transform ? e.transform(t.css) : e.transform.default(t.css))
        )
          return function () {}
        t.css = r
      }
    ...
    var _r,
      ...
      v = (function (t) {
        function e(e, n) {
          ...
          return (
            (i.options = new g.a(n)),
            i.options.setDefault(new g.a(p.a.instance.image.default).getPrintElementOptionEntity()),
            i
          )
        }
      ...
      T = (function () {
        ...
        return (
          ...
          (t.prototype.createPaperNumber = function (t) {
            ...
            var i = $(
              '<span class="hiprint-paperNumber"  style="position: absolute">' + t + '</span>',
            )
            return (
          ...
          (t.prototype.updatePaperNumber = function (t, e, n) {
            ...
            this.paperNumberDisabled
              ...
              : n &&
                this.index % 2 == 1 &&
                ((i[0].style.left = ''), i.css('right', this.paperNumberLeft + 'pt'))
          }),
      ...
      w = (function (t) {
        ...
        return (
          ...
          (e.prototype.getDesignTarget = function (e) {
            ...
            return (
              n.find('.hiprint-printElement-longText-content').css('border', '1px dashed #cebcbc'),
              n
            )
          }),
          ...
          (e.prototype.getHeightByData = function (t) {
            ...
            return (
              this.removeTempContainer(),
              e[0].referenceElement.bottomInLastPaper - e[0].referenceElement.printTopInPaper
            )
          }),
          ...
          (e.prototype.getPaperHtmlResult = function (t, e, n) {
            ...
            if (
              (u.forEach(function (t, e) {
                var n =
                  0 != i.options.leftSpaceRemoved ? (t || '').toString().replace(/^\s*/, '') : t
                ;((l = l.concat(n.split(''))),
      ...
      O = (function (t) {
        ...
        return (
          ...
          (e.prototype.getbarcodeMode = function () {
            return (
              (null == this.barcodeMode ? this.defaultOptions.barcodeMode : this.barcodeMode) ||
              'CODE128'
            )
          }),
          e
      ...
      S = (function (t) {
        function e(e, n) {
          ...
          return (
            (i.options = new R(n)),
            i.options.setDefault(new R(p.a.instance.html.default).getPrintElementOptionEntity()),
            i
          )
        }
          ...
          (e.prototype.createTarget = function (t, e) {
            ...
            if (i) {
              ...
              this.options.content &&
                n.find('.hiprint-printElement-html-content').append(this.options.content)
      ...
      J = (function (t) {
        function e(e, n) {
          ...
          return (
            (i.options = new q(n)),
            i.options.setDefault(
              new q(p.a.instance.tableCustom.default).getPrintElementOptionEntity(),
            ),
        ...
        return (
          ...
          (e.prototype.createTarget = function (t, e, n) {
            ...
            return (
              i.find('.hiprint-printElement-table-content').append(this.getTableHtml(e, n)),
              i
            )
          }),
            ...
            this.designPaper
              ...
              .on('mousemove', function (e) {
                s.a.instance.draging ||
                  (1 === e.buttons &&
                    (t.mouseRect.updateRect(e.pageX, e.pageY), t.updateRectPanel(t.mouseRect)))
              })
            ...
            for (
              var i = $('<ul class="hiprint-pagination"></ul>'),
                o = function o() {
                  var t = r,
                    e = $(
                      '<li><span>' + (t + 1) + '</span><a href="javascript:void(0);">x</a></li>',
                    )
                ...
                ;(s.open('GET', $(p).attr('href')),
                  (s.onreadystatechange = function () {
                    if (
                      ...
                      200 === s.status &&
                      ((o[a + ''] =
                        '<style rel="stylesheet" type="text/css">' + s.responseText + '</style>'),
                      ++i == r.length)
                    ) {
